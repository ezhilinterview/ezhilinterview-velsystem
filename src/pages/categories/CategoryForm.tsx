    ...
    <div className="p-4 sm:p-6 max-w-7xl mx-auto min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors">
      ...
      <div className="mb-6">
        <button
          ...
          className="flex items-center text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 mb-3 text-sm transition-colors"
        >
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-5 border border-gray-200 dark:border-gray-700">
              ...
              <div className="grid grid-cols-8 sm:grid-cols-10 gap-2.5">
                    ...
                    <div className="grid grid-cols-6 gap-2">
                      {icons.map((icon) => (
                        <button
                          ...
                          title={icon}
                          className={`relative p-3 rounded-lg transition-all flex justify-center items-center group ${
                            selectedIcon === icon
